...
def dynamic_rnn_decoder(cell, decoder_fn, inputs=None, sequence_length=None,
    ...
    with ops.name_scope(name, "dynamic_rnn_decoder",
        ...
        outputs_ta, final_state, final_loop_state, state_ta = rnn.raw_rnn(
        ...
        if not time_major:
            ...
            states = array_ops.transpose(states, perm=[1, 0, 2])
        return outputs, final_state, final_context_state, states
